...
const Home = () => {
  ...
  return (
    <>
      <Nav />
      <dotlottie-player
        src="https://lottie.host/662182be-34a0-409d-83db-4a4c1e20abfb/h5nzuKzeHk.json"
      ...
      <div className="w-[50%] mx-auto mb-[30px]">
        <Card className="w-auto shadow-md  text-black">
          ...
          <CardContent className="flex flex-col justify-center gap-4">
            <img src={th} className="rounded-lg w-full h-full"></img>
            <p className="text-lg font-hind">
              {isExpanded ? fullText : `${fullText.slice(0, 170)}...`}{" "}
            </p>
            <button
      ...
      <div className="w-[50%] mx-auto my-2">
        <Card className="w-auto shadow-md ">
          ...
          <CardContent className="flex flex-col justify-center gap-4">
            <img src={th2} className="rounded-lg"></img>
            <p className="text-lg">
