...
const Admindash = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-between border border-red-500 w-[90%] mx-auto gap-2">
        <Label className="text-[30px]">
          Faculty Name: <span className="font-gray-500">JOHN</span>
        </Label>

        <Label className="text-[30px]">
          Faculty Email: <span className="font-gray-500">123@gmail.com</span>
        </Label>

        <Button className="px-5 py-2 ring ring-red-500 text-md bg-white text-black hover:bg-red-500 hover:text-white h-auto">Logout</Button>
      </div>
        ...
        <div className="flex flex-col gap-2">
          <Card className="w-auto shadow-md ">
            ...
            <CardContent className="flex flex-col justify-center gap-4">
              <img src={th} className="rounded-lg" alt="Post Thumbnail" />
              <p className="text-lg">
